...
export default function JobListItem({
  ...
  return (
    <div className="relative grid grid-cols-[auto_1fr_auto_auto_auto] items-center gap-4 py-4 border-b border-neutral-100 last:border-0">
      ...
      <div className="min-w-0">
        <div className="flex items-center gap-2">
          ...
          {matchPercentage !== undefined && (
            <span className="shrink-0 rounded-full bg-green-50 px-2 py-0.5 text-xs font-bold text-success">
