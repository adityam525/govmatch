...
interface RecommendedJobsSidebarProps {
  matches: any[];
}

export default function RecommendedJobsSidebar({ matches }: RecommendedJobsSidebarProps) {
  ...
  return (
    <Card padding="lg">
      ...
      <Link href="/jobs" className="flex items-center justify-center gap-1 text-sm font-medium text-primary-600 hover:text-primary-700 mt-3">
