...
export const emptyPost: PostDraft = {
  ...
  vacancies: "",
  qualificationBlocks: [
    { qualificationCategorySlug: "", qualificationId: "", branchIds: [] },
  ],
  minAge: "18",
  maxAge: "21",
  payScale: "",
...
export default function PostsFieldArray({
  posts,
  onChange,
}: PostsFieldArrayProps) {
    ...
    <div className="md:col-span-2 border-t border-neutral-100 pt-5 mt-2">
      ...
      {posts.length === 0 && (
        <p className="text-xs text-neutral-400 mb-3">
          No posts added yet. Click "Add Post" to add one.
        </p>
      )}
      ...
      <div className="space-y-4">
        {posts.map((post, index) => (
          <div
            key={index}
            className="border border-neutral-200 rounded-lg p-4 relative"
          >
            <button
              type="button"
            ...
            <div className="grid md:grid-cols-2 gap-3 pr-6">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    updatePost(index, "employmentType", e.target.value)
                  }
                  className="w-full text-sm border border-neutral-200 rounded-md px-3 py-2 outline-none focus:border-primary-500"
                >
              ...
              <PostQualificationCascade
                ...
                onChange={(blocks) =>
                  updatePost(index, "qualificationBlocks", blocks)
                }
              />
              ...
              <div>
                ...
                <input
                  ...
                  value={post.payScale}
                  onChange={(e) =>
                    updatePost(index, "payScale", e.target.value)
                  }
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <input
                    ...
                    value={post.minAge}
                    onChange={(e) =>
                      updatePost(index, "minAge", e.target.value)
                    }
                    className="w-full text-sm border border-neutral-200 rounded-md px-3 py-2 outline-none focus:border-primary-500"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    value={post.maxAge}
                    onChange={(e) =>
                      updatePost(index, "maxAge", e.target.value)
                    }
                    className="w-full text-sm border border-neutral-200 rounded-md px-3 py-2 outline-none focus:border-primary-500"
                  />
                </div>
