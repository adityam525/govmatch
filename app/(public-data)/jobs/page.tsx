...
export default function JobsPage() {
  ...
  // Lookup keyed by post id (used when a notification has posts) and
  // also by notification id (used when a notification has no posts,
  // per the fallback in features/jobs/adapters.ts).
