...
const fields: FieldConfig[] = [
  { name: 'notificationId', label: 'Notification ID (optional)', type: 'text', placeholder: 'Leave blank if general document' },
...
export default function NewDocumentPage() {
  const { save } = useAdminRecord('documents');
  return (
    <div className="p-6 max-w-2xl">
      <RecordForm title="Add Document" fields={fields} onSubmit={(v) => save(v)} backHref="/admin/documents" />
    </div>
  );
}
